//
//  NativeHorizontalBarChart.swift
//  NativeChart
//
...
class NativeHorizontalBarChart : HorizontalBarChartView, OptimisedBarLineChart {
    ...
    func setupChart(chart: BarLineChartViewBase) {
        ...
        // Custom style for rightAxis, draw label for axis
